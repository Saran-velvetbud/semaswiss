        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none space-y-6">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-10">About the Site</h2>
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-10">Categories of Information We Collect</h2>
              <p className="text-gray-600 mb-4 leading-relaxed">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                                We may also automatically collect certain technical information relating to you, which your web browser automatically sends whenever you visit a website on the Internet, or which is collected when you use a mobile application (see the section "Cookies and Similar Tools" below for more information). For example, we use Google Analytics, a web analytics service provided by Google, Inc. ("Google") to collect information relating to your use of the Site. Google Analytics uses "cookies", which are text files placed on your device, to help us analyze how you use our Site. You can find out more about how Google uses data by visiting "How Google uses information from sites or apps that use our services", located at <a href="https://policies.google.com/technologies/partner-sites" className="text-sema-red hover:underline" target="_blank" rel="noopener noreferrer">https://policies.google.com/technologies/partner-sites</a>.
              </p>

              <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-10">How We Use the Information We Collect</h2>
              <p className="text-gray-600 mb-4 leading-relaxed">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-10">How We Share Information We Collect</h2>
              <p className="text-gray-600 mb-4 leading-relaxed">
              ...
              <ul className="list-disc pl-6 md:pl-8 text-gray-600 mb-8 space-y-3">
                ...
                <li>If required to do so by law or if we have a good faith belief that disclosure is necessary to (1) comply with the law or with legal process served on us; (2) protect and defend our rights or property; or (3) to protect someone's safety.</li>
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-10">Information Security</h2>
              <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                                The Site does not currently respond to "do not track" signals or other mechanisms that provide a method to opt out of the collection of information over time and across websites and online services you may use. If we do so in the future, we will describe how we do so in this Privacy Policy. Visit the following website, for more information on this developing area. <a href="http://www.allaboutdnt.org" className="text-sema-red hover:underline" target="_blank" rel="noopener noreferrer">www.allaboutdnt.org</a>
              </p>

              <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-10">Information About Minors</h2>
              <p className="text-gray-600 mb-6 leading-relaxed">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-10">Links to Other Websites</h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-10">Cookies and Similar Tools</h2>
              <p className="text-gray-600 mb-6">
              ...
              <h2 className="text-2xl font-semibold text-gray-900 mb-4 mt-10">Changes and Updates</h2>
              <p className="text-gray-600 mb-6">
