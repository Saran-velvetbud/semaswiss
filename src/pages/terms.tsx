      ...
      <Header />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                These Terms of Use ("Terms of Use") are applicable to your access to and use of the Sema Swiss website
                                located at <a href="http://semaswiss.com/" className="text-sema-red hover:underline" target="_blank" rel="noopener noreferrer">http://semaswiss.com/</a> (throughout these Terms of Use, and the website may collectively be referred to as the "Site"
                                or may be referred to individually) and any materials, information, products, or services ("Services") provided through
                                the Site operated by or on behalf of Sema Swiss and/or our owners and/or affiliates (collectively "Company," "our," "us," or "we")
                                or contracted by Sema Swiss and provided by a third party (collectively "Third Party").
                            </p>

                            <p className="text-gray-600 mb-6">
                                Your access to and use of the Site, and the information and Services available through the Site, are subject to the terms,
                                conditions and notices contained in or referenced in these Terms of Use, as well as any other written agreement between us and you.
                                In addition, when using particular Services on the Site, you will be subject to any posted rules applicable to those Services
                                that may contain terms and conditions in addition to those in these Terms of Use.
                            </p>

                            <p className="text-gray-600 mb-8">
                                By accessing or using the Site, you agree to these Terms of Use, as updated from time to time. Please read them carefully.
                                If you do not understand or agree to be bound by these Terms of Use, do not access or use the Site or Services. We may revise
                                these Terms of Use at any time and any revisions will take effect immediately upon posting on this Site, unless we state otherwise.
                            ...
                            <p className="text-gray-600 mb-6">
                                WE ASSUME NO LIABILITY OR RESPONSIBILITY FOR DAMAGES OR INJURY TO PERSONS OR PROPERTY ARISING FROM ANY USE OF ANY MATERIALS, CONTENTS, PRODUCTS, SUPPLIES, INFORMATION, IDEAS, OR ADVICE CONTAINED IN THE APP, Sema Swiss, AND/OR SERVICES.
                            </p>
                            ...
                            <div className="  p-4 mb-6">
                                <p className=" font-semibold">
                                    YOU ARE ADVISED TO ALWAYS SEEK THE ADVICE OF YOUR DOCTOR OR OTHER QUALIFIED HEALTHCARE PROVIDER REGARDING ANY MEDICAL CONDITION AND BEFORE STARTING ANY NEW TREATMENT OR ALTERING YOUR EXISTING TREATMENT. THE APP, Sema Swiss, AND THE SERVICES ARE NOT INTENDED AS A SUBSTITUTE FOR PROFESSIONAL ADVICE FROM A QUALIFIED HEALTHCARE PROVIDER FAMILIAR WITH YOU AND YOUR UNIQUE MEDICAL HISTORY. YOU UNDERSTAND AND AGREE THAT YOU SHALL NOT DISREGARD PROFESSIONAL MEDICAL ADVICE OR DELAY SEEKING PROFESSIONAL MEDICAL ADVICE BECAUSE OF SOMETHING YOU READ OR LEARNED FROM THE APP, Sema Swiss, AND/OR THE SERVICES.
                                </p>
                            </div>

                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Our Services</h2>
                            <p className="text-gray-600 mb-6">
                                Services offered through the Site are NOT health insurance benefits or policies and are not intended as a substitute for health insurance. By ordering from <a href="http://semaswiss.com/" className="text-sema-red hover:underline" target="_blank" rel="noopener noreferrer">semaswiss.com</a> you agree that you may not submit a claim for telemedicine services provided to Medicare, any other federal payor, or any state or private payor.
                            </p>
                            ...
                            <p>Important Contact Information by State</p>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">FLORIDA BILL OF RIGHTS FOR WEIGHT LOSS</h2>
                            <p>http://www.leg.state.fl.us/statutes/index.cfm?App_mode=Display_Statute&URL=0500-0599/0501/Sections/0501.0575.html
                            </p>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">CALIFORNIA NOTICE TO CONSUMERS</h2>
                            <p className="text-gray-600 mb-6">
                            ...
                            <a href="http://www.mbc.ca.gov/" className="text-gray-600 mb-4" rel="noopener noreferrer">
                                www.mbc.ca.gov/
                            </a>

                            <p className="text-gray-600 mb-2">
                                Complaints may be filed online at <a href="http://www.mbc.ca.gov/" className="text-gray-600 mb-4" rel="noopener noreferrer">www.mbc.ca.gov/</a>
                            </p>

                            <p className="text-gray-600 mb-2">
                                Breeze/Complaints.aspx or submitted in hard copy form. A Consumer Complaint Form, including instructions for completing it, may be found at <a href="http://www.mbc.ca.gov/" className="text-gray-600 mb-4" rel="noopener noreferrer">www.mbc.ca.gov/</a>
                            </p>
                            ...
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">TEXAS</h2>
                            ...
                            <p className="text-gray-600 mb-2">
                                Assistance in filing a complaint is available by calling 1-800-201-9353. For more information, visit <a href="http://www.tmb.state.tx.us/" className="text-gray-600 mb-4" rel="noopener noreferrer">www.tmb.state.tx.us</a>
                            </p>
                            ...
                            <p className="text-gray-600 mb-6">
                                Si necesita ayuda para presentar una queja, lame al: 1-800-201-9353, Para obtener más información, visite nuestro sitio web en <a href="http://www.tmb.state.tx.us/" className="text-gray-600 mb-4" rel="noopener noreferrer">www.tmb.state.tx.us</a>.
                            </p>

                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">KANSAS</h2>
                            ...
                            <p className="text-gray-600 mb-6">
                                Website: <a href="http://www.ksbha.org/" className="text-gray-600 mb-4" rel="noopener noreferrer">www.ksbha.org</a>
                            </p>
                            ...
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Electronic Communications</h2>
                            ...
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">ForeverLifeLabs Intellectual Property</h2>
                            ...
                            All custom graphics, icons, logos, design marks and service names are registered trademarks, trademarks or service marks of ForeverLifeLabs and its owners. All other trademarks or service marks are property of their respective owners. Nothing in these Terms of Use grants you any right to use any trademark, service mark, logo, and/or the name of ForeverLifeLabs.
                            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Minors and Use of Service as a Legal Guardian</h2>
                            ...
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Your Conduct</h2>
                            ...
                            <p className="text-gray-600 mb-6">
                                Non-affiliated companies will be solely responsible and liable for the provision of or failure to provide stated services, benefits, or products. We do not legally endorse or guarantee products or services provided by non-affiliated companies.
                            </p>
                            ...
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Security and Safety</h2>
                            ...
                            <p className="text-gray-600 mb-6">
                             ...
                             <h2 className="text-2xl font-semibold text-gray-900 mb-4">Changes to These Terms of Use</h2>
                             ...
                             <h2 className="text-2xl font-semibold text-gray-900 mb-4">Access or Use Outside the United States</h2>
                             
                             <p className="text-gray-600 mb-6">
                                 Although the Site may be accessed by any user worldwide, the Site and Services are intended only for use by United States residents, are presented solely as a service to visitors and subscribers located in the United States of America ("U.S.") and its territories, and therefore may not comply with legal requirements of foreign countries. Sema Swiss and the App are intended for use only by residents of the United States and its territories. Users residing outside of the U.S. and its territories are not permitted to register or to use the Services.
                             </p>
                             ...
                             <h2 className="text-2xl font-semibold text-gray-900 mb-4">Operation of the Site</h2>
                             ...
                             <p className="text-gray-600 mb-4">
                                 If you believe any material available via the Site or Services infringes, specifically or generally upon a copyright, you should notify us using the notice procedure for claimed infringement under the DMCA (17 U.S.C. Sect. 512(c)(2)). We will respond expeditiously to remove or disable access to the material claimed to be infringing upon said copyright and will follow the procedures specified in the DMCA to resolve the claim between the notifying party and the alleged infringer who provided the content.
                             </p>
