    ...
    <div className="min-h-screen bg-medical-bg">
      <Header />
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Semaswiss Intellectual Property</h2>
                            ...
                            All custom graphics, icons, logos, design marks and service names are registered trademarks, trademarks or service marks of Semaswiss and its owners. All other trademarks or service marks are property of their respective owners. Nothing in these Terms of Use grants you any right to use any trademark, service mark, logo, and/or the name of Semaswiss.
